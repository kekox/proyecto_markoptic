      ...
      <div class="row">
        ...
        <div class="col-sm-10 col-md-5  col-md-offset-1 col-lg-4 col-lg-offset-1 pull-top">
          ...
          <div class="panel-body ">
              ...
              <center><span class="bg-warning display-warning"id="mensaje"></span></center>
              ...
              @endif
                ...
                <span class="bg-danger display-errors" >  {{ $errors->first('email') }}</span>
               
                <p>{{ Form::label('password', 'password') }}
                {{ Form::password('password') }}</p>
                <span class="bg-danger display-errors" id="_password">  {{ $errors->first('password') }}</span>
               
                <p>{{ Form::label('password_confirmation', 'password confirm') }}
                {{ Form::password('password_confirmation') }}</p>
                 <span class="bg-danger display-errors" id="_password">  {{ $errors->first('password_confirmation') }}</span>
