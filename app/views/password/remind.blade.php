	...
	<div class="jumbotron" style="margin-bottom:-30px; margin-top:-20px; ">
		<div class="container" style="background-color:white; border: #e0e0e0 1px solid; ">
			...
			<div class="row">
				...
				<center>
				<h3 class="alert alert-success "><small>{{HTML::link('/',' ',array('class' => 'glyphicon glyphicon-arrow-left color-black pull-left' ))}}</small><span class="glyphicon glyphicon-wrench" ></span> Password Recovery</h3>
				</center></div>
				<hr>
			</div>	
